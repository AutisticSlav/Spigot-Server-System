...
public class FileManager {
	...
	public static void Manager() {
		...
		inv_teleporter.addDefault("Background.6", 14);
		inv_teleporter.addDefault("Background.7", 15);
		inv_teleporter.addDefault("Background.8", 14);
		inv_teleporter.addDefault("Background.9", 15);
		inv_teleporter.addDefault("Background.10", 14);
		inv_teleporter.addDefault("Background.11", 15);
		inv_teleporter.addDefault("Background.12", 15);
		inv_teleporter.addDefault("Background.13", 14);
		inv_teleporter.addDefault("Background.14", 15);
		inv_teleporter.addDefault("Background.15", 14);
		inv_teleporter.addDefault("Background.16", 15);
		inv_teleporter.addDefault("Background.17", 15);
		inv_teleporter.addDefault("Background.18", 14);
		inv_teleporter.addDefault("Background.19", 15);
		inv_teleporter.addDefault("Background.20", 14);
		inv_teleporter.addDefault("Background.21", 15);
		inv_teleporter.addDefault("Background.22", 14);
		inv_teleporter.addDefault("Background.23", 14);
		inv_teleporter.addDefault("Background.24", 14);
		inv_teleporter.addDefault("Background.25", 15);
